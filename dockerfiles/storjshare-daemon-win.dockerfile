...
ADD https://raw.githubusercontent.com/Storj/dgpnode-daemon/master/dockerfiles/get_dep_ver.ps1 get_dep_ver.ps1
...
RUN .\get_dep_ver.ps1; \
    ...
    Write-Host npm install --global dgpnode-daemon --unsafe-perm; npm install --global dgpnode-daemon --unsafe-perm; \
    ...
    Write-Host dgpnode --version; dgpnode --version;
